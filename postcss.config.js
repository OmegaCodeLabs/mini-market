 ...
 *
 * Plugins:
 * - @tailwindcss/postcss: Processes Tailwind directives (@import "tailwindcss") and generates utility classes
 * - autoprefixer: Automatically adds vendor prefixes (-webkit-, -moz-, etc.) for browser compatibility
 */
export default {
  plugins: {
    '@tailwindcss/postcss': {},    // Enables Tailwind CSS v4 processing
